...
def create_welcome_frame(parent):
    ...
    welcome_text = (
        "PhotoUtils — это локальная утилита для работы с фотографиями.\n\n"
        "Она поможет вам:\n"
        " ✔ Найти и удалить дубликаты изображений\n"
        " ✔ Переименовать файлы по шаблону\n"
        " ✔ Удалить скрытые метаданные (EXIF, GPS и др.)\n"
        " ✔ Конвертировать HEIC и другие форматы в JPG/PNG\n"
        " ✔ Повысить качество фото через встроенные настройки\n\n"
